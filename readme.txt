...
* Viewing Submissions: Navigate to "Form Submissions Manager" from your WordPress admin dashboard to view all captured submissions.

* Filtering: Use the dropdowns to filter submissions by form plugin and specific forms.

* Exporting to CSV: Click on the "Export CSV" button to download the current filtered list of submissions.

* Emailing Submissions: Click the "Email" button next to a submission to open a popup where you can enter email addresses and send the submission data.

* Deleting Submissions: Use the "Delete" button to remove a submission you no longer need.
